...
namespace InventarioApi.Migrations
{
    ...
    [Migration("20190825130711_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventarioApi.Entities.Persona", b =>
                {
                    b.HasOne("InventarioApi.Entities.Area", "Area")
                        .WithMany("Personas")
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InventarioApi.Entities.Tdocumento", "Tdocumento")
                        .WithMany("Personas")
            ...
            modelBuilder.Entity("InventarioApi.Entities.PersonaElemento", b =>
                {
                    b.HasOne("InventarioApi.Entities.Elemento", "Elemento")
                        .WithMany("PersonaElementos")
                        .HasForeignKey("ElementoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InventarioApi.Entities.Persona", "Persona")
                        .WithMany("PersonaElementos")
